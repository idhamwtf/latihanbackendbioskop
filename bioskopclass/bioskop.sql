...
INSERT INTO `genre` VALUES (1,1,'horror'),(2,1,'romance'),(3,3,'sci-fi');
...
INSERT INTO `movies` VALUES (1,'ape','image.jpg','hiya','dzaky','youtube.com','pwd');
...
CREATE TABLE `studio` (
  ...
  `jumlahKursi` varchar(50) NOT NULL,
...
INSERT INTO `users` VALUES (1,'dzakyasu','asu123',2);
...
-- Dump completed on 2020-01-23 14:10:43
